...
class LazyRoundRobbinTest extends JUnitSuite {
  ...
  def testLazyRoundRobbinLoop {
    ...
    val rr = LazyRoundRobbin.counted(List(stream1))
...
//
//    lrr addStreamable UnaryStream.counted(lrr, (x: Int) => x + 1 )
//
//    lrr.initialize
//
...
//
//    rr.addStreamable(WrapperStream.counted(5))
//    rr.addStreamable(WrapperStream.counted(9))
//
//    rr.initialize
//
//    val stream = rr.getStream
...
//      getSingleStream(7))
//
//    val rr = LazyRoundRobbin.counted(streams)
//
//    rr addStreamable rr
//    rr addStreamable WrapperStream.counted(5)
//    rr addStreamable rr
...
//    val rr = LazyRoundRobbin(streams)
//
//    val us = UnaryStream.counted(rr, { (_: Int) + 1 }, { (_: Int) + 1 })
//    val ss2 = WrapperStream.counted(5)
//    
//    rr addStreamable us
...
//
//    val us = UnaryStream.counted(rr, { (_: Int) + 1 }, { (_: Int) + 1 })
//    val ss2 = WrapperStream.counted(2)
//    
//    rr addStreamable us
//    rr addStreamable ss2
//
